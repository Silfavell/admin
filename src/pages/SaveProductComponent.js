...
class SaveProductComponent extends Component {
  ...
  getCategories = () =>
    axios
      .get(`${process.env.REACT_APP_API_URL}/categories/as-map`)
  ...
  onChange = (event) => {
    ...
    this.state.products.map((product) => {
      if (product._id === value) {
        ...
        productObj.specifications = product.specifications.filter(
          (spec) => spec.name !== "Renk Tonu"
        );
  ...
  getFormData = () => {
    ...
    if (this.specificationsRef.current) {
      const specifications = Object.keys(this.specificationsRef.current.state)
    ...
    if (subCategoryId.trim().length > 0)
      formData.append("subCategoryId", subCategoryId.trim());
    ...
    if (colorGroup.trim().length > 0)
      formData.append("colorGroup", colorGroup.trim());
    if (colorName.trim().length > 0 && colorCode.trim().length > 0) {
      formData.append(
        "color",
        JSON.stringify({
          name: colorName.trim(),
    ...
    if (discountedPrice.toString().trim().length > 0)
      formData.append("discountedPrice", discountedPrice.toString().trim());
  ...
  onSaveProductClick = () => {
    if (
      window.confirm(
        `${this.state.name} isimli ürünü eklemek istediğinize emin misiniz?`
      )
    ) {
  ...
  getImageData = (target, imageFile) => {
    ...
    reader.onload = (event) => {
      if (target) target.src = event.target.result;
    };
      ...
      <div className="p-3 border">
        <div className="col-md-12">
          <div className="form-group row">
            <div className="col-md-12">
              <label htmlFor="updateId" className="text-black">
                Referans Ürün <span className="text-danger">*</span>
              </label>
          ...
          <div className="form-group row">
            <div className="col-md-6">
              ...
              <select
                ...
                value={categoryId}
              >
                <option selected unselectable value={null}>
                  Kategori seçiniz
                </option>
            ...
            <div className="col-md-6">
              <label htmlFor="subCategoryId" className="text-black">
          ...
          <div className="form-group row">
            <div className="col-md-12">
              <label htmlFor="type" className="text-black">
                Ürün Tipi <span className="text-danger">*</span>
              </label>
              <select
                className="form-control"
                id="type"
          ...
          <div className="form-group row">
            <div className="col-md-12">
              ...
              <div className="d-flex">
                ...
                <div
                  className={
                    "ml-2 px-3 border d-flex align-items-center justify-content-center"
                  }
                  style={{ cursor: "pointer" }}
                  onClick={this.changeBrandMode}
                >
                  <IoMdCreate size={24} />
                </div>
              </div>
          ...
          <div className="form-group row">
            <div className="col-md-12">
              <label htmlFor="colorGroup" className="text-black">
                Benzer Ürün
              </label>
          ...
          <div className="form-group row">
            <div className="col-md-6">
              <label htmlFor="colorName" className="text-black">
                Renk adı
              </label>
              <input
                type="text"
                  ...
                  <div class="input-group-text bg-white">
                    <span
                      ...
                      style={{
                        width: 24,
                        height: 24,
                        backgroundColor: this.getColorByCode(),
                      }}
                    />
                  </div>
                </div>
          ...
          <div className="form-group row mt-4">
            <div className="col-lg-12">
              <button
                ...
                onClick={this.onSaveProductClick}
              >
                Ürünü ekle
              </button>
            </div>
